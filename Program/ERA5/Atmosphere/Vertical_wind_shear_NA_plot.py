...
fh 	= netcdf.Dataset(directory+'/Atmosphere/Vertical_wind_shear_NA_month_'+str(month_start)+'-'+str(month_end)+'_'+str(year_start)+'-'+str(year_end)+'.nc', 'r')
...
ax.set_title('a) Reanalysis (ERA5), June - November')
