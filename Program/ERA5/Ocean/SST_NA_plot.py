...
#Get the ERA5 SSTs
fh 			= netcdf.Dataset(directory_era+'Ocean/SST_NA_month_'+str(month_start)+'-'+str(month_end)+'_'+str(year_start)+'-'+str(year_end)+'.nc', 'r')
...
fh 			= netcdf.Dataset(directory_cesm+'Ocean/SST_PRESENT_ERA5_grid_NA_month_'+str(month_start)+'-'+str(month_end)+'.nc', 'r')
lon			= fh.variables['lon'][:]
lat			= fh.variables['lat'][:]
...
ax.set_title('g) Sea surface temperature, UH-CESM$^{\mathrm{PD}}$ minus ERA5')
