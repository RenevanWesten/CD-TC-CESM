...
fh = netcdf.Dataset(directory+'Atmosphere/DGPI_fields_PRESENT_WP_month_'+str(month_start)+'-'+str(month_end)+'.nc', 'r')
...
fh 		= netcdf.Dataset(directory+'Atmosphere/DGPI_fields_FUTURE_WP_month_'+str(month_start)+'-'+str(month_end)+'.nc', 'r')
...
fh 		= netcdf.Dataset(directory+'Atmosphere/DGPI_changes_WP_month_'+str(month_start)+'-'+str(month_end)+'.nc', 'r')
...
ax.set_title('d) DGPI MDR, Western Pacific') 
