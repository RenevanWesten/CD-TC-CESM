...
fh = netcdf.Dataset(directory+'Atmosphere/GPI_fields_PRESENT_NA_month_'+str(month_start)+'-'+str(month_end)+'.nc', 'r')
...
fh = netcdf.Dataset(directory+'Atmosphere/GPI_fields_FUTURE_NA_month_'+str(month_start)+'-'+str(month_end)+'.nc', 'r')
...
fh 		= netcdf.Dataset(directory+'Atmosphere/GPI_changes_NA_month_'+str(month_start)+'-'+str(month_end)+'.nc', 'r')
...
ax.set_title('b) GPI MDR, North Atlantic') 

#-----------------------------------------------------------------------------------------


GPI_diff_plot		= GPI_future_plot - GPI_present_plot
