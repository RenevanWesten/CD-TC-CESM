...
TEMP_data = netcdf.Dataset(directory+'Atmosphere/GPI_index_PRESENT_WP_month_'+str(month_start)+'-'+str(month_end)+'.nc', 'r')
...
TEMP_data = netcdf.Dataset(directory+'Atmosphere/GPI_index_FUTURE_WP_month_'+str(month_start)+'-'+str(month_end)+'.nc', 'r')
