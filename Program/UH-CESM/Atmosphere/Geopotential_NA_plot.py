...
Z3_200_present			= ma.masked_all((5, 280, 354))
Z3_200_future			= ma.masked_all((5, 280, 354))
Z3_850_present			= ma.masked_all((5, 280, 354))
Z3_850_future			= ma.masked_all((5, 280, 354))
...
u_vel_200_present		= ma.masked_all((5, 280, 354))
u_vel_200_future		= ma.masked_all((5, 280, 354))
u_vel_850_present		= ma.masked_all((5, 280, 354))
u_vel_850_future		= ma.masked_all((5, 280, 354))

v_vel_200_present		= ma.masked_all((5, 280, 354))
v_vel_200_future		= ma.masked_all((5, 280, 354))
v_vel_850_present		= ma.masked_all((5, 280, 354))
v_vel_850_future		= ma.masked_all((5, 280, 354))
#-----------------------------------------------------------------------------------------
...
for period in ['PRESENT', 'FUTURE']:
	...
	for ensemble_i in range(len(ensemble_number)):
		...
		print(ensemble_i)
		fh 				= netcdf.Dataset(directory+'_'+str(ensemble_number[ensemble_i]).zfill(3)+'/Atmosphere/Geopotential_NA_month_'+str(month_start)+'-'+str(month_end)+'.nc', 'r')
		...
		fh 			= netcdf.Dataset(directory+'_'+str(ensemble_number[ensemble_i]).zfill(3)+'/Atmosphere/UV_NA_month_'+str(month_start)+'-'+str(month_end)+'.nc', 'r')
