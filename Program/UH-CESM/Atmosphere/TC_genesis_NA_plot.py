...
def BasinCount(track_all):
	...
	NA_lon	= [260, 360, 360, 290, 290, 275, 275, 270, 270, 260, 260]
	NA_lat	= [60, 60, 0, 0, 8, 8, 14, 14, 17.5, 17.5, 60]

	#Re-arrange the coordinates of the corners of domain into single lists
	points_NA	= Points(NA_lon, NA_lat)
	...
	for track_i in range(len(track_all)):
		...
		if Inside_polygon(lon_genesis, lat_genesis, points_NA) == True:
			#North Atlantic region
			NA_gen.append([lon_genesis, lat_genesis])
			continue
